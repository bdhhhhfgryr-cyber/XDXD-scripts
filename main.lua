...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'XDXD\'s Scripts is waiting for the game to load'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "XDXD's Scripts v" .. currentVersion
